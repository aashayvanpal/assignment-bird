    ...
    return (
        <div className='page'>
            ...
            <div className='avoid-costly-errors'>
                ...
                <img src={maintenance} id="maintenance" />
            </div>

            <div className='detailed'>
                <img src={development} id="development" />
